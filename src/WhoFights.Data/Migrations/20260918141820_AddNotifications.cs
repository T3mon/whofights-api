    ...
    public partial class AddNotifications : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationSubscriptions", x => new { x.UserId, x.Kind, x.Channel });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationLogs_UserId_Kind_Channel_Reference",
                table: "NotificationLogs",
                columns: new[] { "UserId", "Kind", "Channel", "Reference" },
                unique: true);
